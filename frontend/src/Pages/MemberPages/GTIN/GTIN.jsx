...
const Gtin = () => {
  ...
  //   try {
  //     const response = await gs1Request.get(`/products?user_id=${memberData?.id}`);
  ...
  //   try {
  //     const response = await gs1Request.get(`/gtinProducts/subcriptionsProducts?status=active&user_id=${memberData?.id}&isDeleted=false`);
  //     console.log(response.data);
  ...
  const handleDelete = async (row) => {
    try {
      const deleteResponse = await gs1Request.delete(`/products/gtin/${row?.id}`);
  ...
  //       gs1Request.post('/products/bulkGtin', formData)
  //         .then((response) => {
  ...
  //     gs1Request.post('/products/bulkGtin?selectedLanguage=' + selectedLanguage, formData)
  //       .then((response) => {
  //         // Handle the successful response
  //         console.log(response.data);
